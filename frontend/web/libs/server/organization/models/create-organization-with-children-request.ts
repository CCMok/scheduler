...
export const createOrganizationWithChildrenRequestSchema = z.object({
  name: z.string().min(1),
...
export type CreateOrganizationWithChildrenRequest = z.infer<typeof createOrganizationWithChildrenRequestSchema>