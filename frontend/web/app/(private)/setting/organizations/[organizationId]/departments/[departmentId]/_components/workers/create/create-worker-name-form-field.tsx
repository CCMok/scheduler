...
import { CreateWorkerFormInput } from "@/app/(private)/setting/organizations/[organizationId]/departments/[departmentId]/_components/workers/create/create-worker-form-input";
