...
class RosterMaterialHelper:
    @staticmethod
    def get_material() -> RosterMaterial:
        return RosterMaterial(
            days=RosterMaterialHelper.__get_days(),
            posts=RosterMaterialHelper.__get_posts(),
            workers=RosterMaterialHelper.__get_workers(),
            posts_constraint_settings=RosterMaterialHelper.__get_posts_constraint_settings(),
        )

    @staticmethod
    def __get_days() -> range:
        return range(4)

    @staticmethod
    def __get_posts() -> list[Post]:
        return [
            Post(
                id=0,
                name='Host',
    ...
    @staticmethod
    def __get_posts_constraint_settings() -> list:
        return [
